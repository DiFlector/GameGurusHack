...
namespace SimplePieMenu
{
    ...
    public class PieMenuItem : MonoBehaviour
    {
        ...
        public void ToggleDisableMenuItem()
        {
            MenuItemDisabler disabler = PieMenuShared.References.MenuItemsManager.MenuItemDisabler;
            disabler.ToggleDisable(pieMenu, id, disabled);
        }
